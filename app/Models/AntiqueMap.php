 ...
 */
class AntiqueMap extends BaseModel
{
    use RevisionableTrait;

    protected $table = 'zl_antique_map';
    ...
    public const ANTIQUE_MAPS_PATH = 'maps_images/';
    ...
    public function setImgAttribute($value)
    {
        if (!empty($this->attributes['img'])) {
            $existingFile = public_path(self::ANTIQUE_MAPS_PATH.$this->attributes['img']);
        ...
        if ($value && $value instanceof \Illuminate\Http\UploadedFile) {
            ...
            $value->move(public_path(self::ANTIQUE_MAPS_PATH), $fileName); 
