                ...
                <div class="col-lg-8 order-lg-0">
                    ...
                    <!-- Name -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="area" id="area" required value="{{ old('area') ?? $user->area }}">
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" class="form-control" name="address" id="address" required value="{{ old('address') ?? $user->address }}">
                        </div>
                        ...
                        <div class="form-group">
                              ...
                              <option value="{{ $city->id }}" {{ old('city', isset($user->city) ? $user->city : '') == $city->id ? 'selected' : '' }}>
                                {{ $city->city_name }}
                              </option>
                              @endforeach
                            </select>
