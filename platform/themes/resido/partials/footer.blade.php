                    ...
                    <div class="footer-widget">
                        @if (theme_option('logo_white'))
                            <img src="{{ RvMedia::getImageUrl(theme_option('logo_white')) }}" class="img-footer"
                                 style="max-height: 100px" alt="{{ theme_option('site_name') }}">
                        @endif
                        <div class="footer-add">
                            @if (theme_option('about-us'))
                                <p><i class="fas fa-map-home-alt"></i> {{ theme_option('about-us') }}</p>
                            @endif
...
<a id="back2Top" class="top-scroll bg-success" title="Back to top" href="#" style="border: 2px solid;border-radius: 50%;width: 70px;height: 70px;"><img style="width: 100%; height: auto;" src="{{asset('assets/top-arrow.png')}}"></a>
</div>
